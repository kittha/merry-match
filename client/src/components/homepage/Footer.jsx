...
function Footer() {
  return (
    <footer className="bg-[#F6F7FC] w-full h-full m-0 p-0">
      <div className="w-[375px] h-[345px] lg:w-[1440px] lg:h-[371px] bg-[#F6F7FC] mx-auto">
        <div className="w-[375px] h-[275px] ld:w-[1120px] flex flex-col justify-space-between gab-[48px] relative top-[48px] lg:left-[160px]">
          <div className="lg:w-[1120px] lg:h-[110px] w-[327px] h-[120px] mx-auto">
            <img
              ...
              alt="logo1"
            />
            <p className="lg:w-[1120px] lg:h-[30px] w-[327px] h-[60px] font-nunito font-semibold text-lg leading-7 text-center text-[#646D89]">
          ...
          <div className="lg:w-[1120px] h-[117px] w-[327px] flex flex-col gap-[24px] pt-[24px] mx-auto">
            <p className="w-[343px] h-[21px] font-nunito font-medium text-sm leading-[21px] text-[#9AA1B9] text-center mx-auto">
